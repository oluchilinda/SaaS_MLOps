"""add feature and pipelines

Revision ID: 51768860f7c2
Revises: 
Create Date: 2021-07-27 19:20:42.077551
...
def upgrade():
    ...
    op.create_table('metadata_pipelines',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=True),
    ...
    sa.Column('created_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_on', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('statistics', sa.Float(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['metadata_id'], ['metadata_pipelines.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('metadata_pipelines')
    op.drop_table('files')
